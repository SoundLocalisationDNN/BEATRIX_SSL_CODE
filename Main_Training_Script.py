...
def augment_audio_data(segment, sr, angle):
    ...
    #For each augmentation, apply it with a probability.
...
if __name__ == '__main__':
    ...
    #List of folder paths where the 2-channel WAV files are stored, change to your path
    
    folder_paths = [r"C:\Users\joesh\Desktop\EarTestData\DataSet1_TIMIT_POS1_1M",
                r"C:\Users\joesh\Desktop\EarTestData\DataSet2_TIMIT_POS1_2M",
                r"C:\Users\joesh\Desktop\EarTestData\DataSet3_TIMIT_POS2_1M",
                r"C:\Users\joesh\Desktop\EarTestData\DataSet4_TIMIT_POS2_2M",
                r"C:\Users\joesh\Desktop\EarTestData\DataSet5_TIMIT_POS3_1M",
                r"C:\Users\joesh\Desktop\EarTestData\Dataset6_TIMIT_POS3_2M"]
    ...
    #Combined Normalisation for Spectrograms
    ...
    #Merge left and right spectrograms to compute a single normalisation statistic.
    ...
    #Normalise both left and right using the same merged mean/std.
    for f in features:
    ...
    unseen_folder = r"C:\Users\joesh\Desktop\EarTestData\UnseenDataset1"
